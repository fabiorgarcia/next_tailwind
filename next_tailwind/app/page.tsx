      ...
      <div className="flex flex-col gap-6 relative">
        ...
        <div className="sm:flex gap-2  ">
          ...
          <div className="flex w-1/2 gap-2">
            ...
            <div className="w-1/4">
              <input type="number" id="default-datepicker"  className="sm:mb-0 mb-2 w-full  flex-auto bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="De R$" />
            </div>
            <div className="w-1/4">
